...
Production features:
• Persistent SQLite database at ~/.wien2k_gen/history.db with auto-created schema
...
DEFAULT_HISTORY_DIR = Path.home() / ".wien2k_gen"
...
class ExecutionHistory:
    ...
    def __init__(self, db_path: Optional[Union[str, Path]] = None) -> None:
        ...
        Args:
            db_path: Path to SQLite database file. Defaults to ~/.wien2k_gen/history.db.
        """
        if db_path is None:
