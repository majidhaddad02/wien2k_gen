"""
Centralized Exception Hierarchy & Error Context Manager for FORGE.
...
class FORGEError(Exception):
    ...
    def _generate_default_hint(self) -> str:
        ...
        return hints.get(self.domain, "Consult documentation or run forge --diagnostics")
...
class TopologyError(FORGEError):
...
class HPCRuntimeError(FORGEError):
...
def format_error_for_ui(error: FORGEError) -> str:
    """
...
def is_wien2k_error(exc: Exception) -> bool:
    ...
    return isinstance(exc, FORGEError)
